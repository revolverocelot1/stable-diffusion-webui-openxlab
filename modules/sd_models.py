...
def list_models():
    ...
    if shared.cmd_opts.no_download_sd_model or cmd_ckpt != shared.sd_model_file or os.path.exists(cmd_ckpt):
        ...
        # Use OpenXLab model instead of Hugging Face
        model_url = "https://code.openxlab.org.cn/api/v1/repos/xiaozhijason/openxl/media/openxlv3.safetensors?ref=main"

    model_list = modelloader.load_models(model_path=model_path, model_url=model_url, command_path=shared.cmd_opts.ckpt_dir, ext_filter=[".ckpt", ".safetensors"], download_name="openxlv3.safetensors", ext_blacklist=[".vae.ckpt", ".vae.safetensors"])
